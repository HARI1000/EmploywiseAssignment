...
function Login() {
    ...
    useEffect(() => {
        ...
        //logic for storing the user data in local storage
        ...
        <div className="flex items-center justify-center w-screen h-screen p-1">
            <div className="p-4 text-center border-2 border-black rounded-xl">
                ...
                <Button onClick={() => {
                    ...
                    //Logic for checking if email is given and format of email is correct
                ...
                {/* logic for showing login successful */}
                {success ?
                    <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50" >
                        <span class="font-medium">Successfully Loggedin</span>
                    </div> :
                    <></>}
                {/* logic for showing if error occured */}
                {error ?
